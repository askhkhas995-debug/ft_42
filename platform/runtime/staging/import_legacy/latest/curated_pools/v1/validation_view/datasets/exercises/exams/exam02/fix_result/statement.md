...
```text
Assignment name  : fix_result
Expected files   : fix_result.c
Allowed functions: write, exit
Version          : 1
--------------------------------------------------------------------------------

copy and fix the code below so Checks if it's even or odd Calculates the sum of all numbers from 1 to that number.
